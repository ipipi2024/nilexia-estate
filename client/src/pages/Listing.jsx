...
export default function Listing() {
  ...
  return (
    <main>
        ...
        {
            error && <p className="text-center my-7 text-2xl">Somethng went wrong!</p>
        }
                ...
                <>
                    ...
                    <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
                        ...
                        <div className="flex gap-4">
                            ...
                            {
                                listing.offer && (
                                    <p className="bg-green-900 w-full max-w-[200px]  text-center text-white
                                    p-1 rounded-md ">
                        ...
                        <ul className=" font-semibold text-sm flex flex-wrap 
